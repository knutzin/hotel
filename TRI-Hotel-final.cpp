    ...
    do
    {
        ...
        switch(opcao)
        {
            ...
            case 3: //Realizar Check-In com reserva
            {
                ...
                {
                    system("cls");
                    printf("\nO quarto ja esta ocupad, tente novamente.\n\n");
                    continue;
                }
                ...
                if(tab[i][j] != 'O')
                {
    				...
    				printf("\nDeseja fazer o cadastro? ('1' para sim, '2', para nao): ");
                	scanf("%d", &escolha);
					...
					{
						system("cls");
				 		printf("atencao!, o quarto do andar %d, apartamento %d, nao possui cadastro do hospede!!", i, j);
				 		break;
					}
				}
            ...
            {   
				...
				{
					system("cls");
					printf("aviso!, o quarto do andar %d, apartamento %d, esta sem cadastro do hospede!!", i, j);
					break;
				}
			...
			case 8: //Consultar quarto
			{
                ...
                if (strlen(hospedes[i][j].nome) == 0) // Verifica se não há cadastro associado ao quarto
        		{
        		system("cls");
            	printf("Nao ha um cadastro nesse quarto.\n");
            	continue; 
        		}
				...
				{
					system("cls");
				    printf("Status do quarto andar %d, apartamento %d: Livre\n", i, j);
				    printf("Nenhum hospede encontrado\n\n");
				    continue;
  				}
